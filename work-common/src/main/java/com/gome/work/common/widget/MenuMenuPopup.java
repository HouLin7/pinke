 ...
 */
public class MenuMenuPopup extends BaseMenuPopupWindow {

    private PopMenuRecyclerAdapter mAdapter;

    public MenuMenuPopup(Context context, String... menus) {
        this(context, Arrays.asList(menus));
    }

    public MenuMenuPopup(Context context, List<String> menuList) {
