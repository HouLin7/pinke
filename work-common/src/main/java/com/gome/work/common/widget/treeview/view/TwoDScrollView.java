...
package com.gome.work.common.widget.treeview.view;
...
public class TwoDScrollView extends FrameLayout {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
         ...
         * scrolling there. Shortcut the most recurring case: the user is in the
         * dragging state and he is moving his finger. We want to intercept this
         * motion.
         */
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (deltaX < 0) {
                    ...
                    final int rightEdge = getWidth() - getPaddingRight();
                    final int availableToScroll = getChildAt(0).getRight() - getScrollX()
                            - rightEdge;
                ...
                if (deltaY < 0) {
                    ...
                    final int bottomEdge = getHeight() - getPaddingBottom();
                    final int availableToScroll = getChildAt(0).getBottom() - getScrollY()
                            - bottomEdge;
                    if (availableToScroll > 0) {
    ...
    public void fling(int velocityX, int velocityY) {
        if (getChildCount() > 0) {
            ...
            View newFocused = findFocusableViewInMyBounds(movingRight, mScroller.getFinalX(),
                    movingDown, mScroller.getFinalY(), findFocus());
            if (newFocused == null) {
                newFocused = this;
            }
