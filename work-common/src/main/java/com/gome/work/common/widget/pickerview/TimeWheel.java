package com.gome.work.common.widget.pickerview;

import android.content.Context;
import android.view.View;

import com.gome.work.common.R;
import com.gome.work.common.widget.pickerview.adapters.NumericWheelAdapter;
import com.gome.work.common.widget.pickerview.config.PickerConfig;
import com.gome.work.common.widget.pickerview.data.source.TimeRepository;
import com.gome.work.common.widget.pickerview.utils.PickerContants;
import com.gome.work.common.widget.pickerview.utils.Utils;
import com.gome.work.common.widget.pickerview.wheel.OnWheelChangedListener;
import com.gome.work.common.widget.pickerview.wheel.WheelView;
...
public class TimeWheel {
    ...
    void initYear() {
        ...
        mYearAdapter = new NumericWheelAdapter(this, mContext, minYear, maxYear, PickerContants.FORMAT, mPickerConfig.mYear);
    ...
    void updateMonths() {
        ...
        mMonthAdapter = new NumericWheelAdapter(this, mContext, minMonth, maxMonth, PickerContants.FORMAT, mPickerConfig.mMonth);
        mMonthAdapter.setConfig(mPickerConfig);
        mMonthAdapter.setYear(curYear);
    ...
    void updateDays() {
        ...
        int minDay = mRepository.getMinDay(curYear, curMonth);
        mDayAdapter = new NumericWheelAdapter(this, mContext, minDay, maxDay, PickerContants.FORMAT, mPickerConfig.mDay);
        mDayAdapter.setConfig(mPickerConfig);
        mDayAdapter.setYear(curYear);
        mDayAdapter.setMonth(curMonth);
    ...
    void updateHours() {
        ...
        mHourAdapter = new NumericWheelAdapter(this, mContext, minHour, maxHour, PickerContants.FORMAT, mPickerConfig.mHour);
    ...
    void updateMinutes() {
        ...
        mMinuteAdapter = new NumericWheelAdapter(this, mContext, minMinute, maxMinute, PickerContants.FORMAT, mPickerConfig.mMinute);
