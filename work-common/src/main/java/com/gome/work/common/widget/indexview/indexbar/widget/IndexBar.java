package com.gome.work.common.widget.indexview.indexbar.widget;
...
import com.gome.work.common.widget.indexview.indexbar.helper.IIndexBarDataHelper;
import com.gome.work.common.widget.indexview.indexbar.helper.IndexBarDataHelperImpl;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mIndexDatas.size(); i++) {
            ...
            if (currentChoosenAlphabetIndex ==i){
                ...
                mPaint.setColor(getResources().getColor(R.color.app_gray_light));
            }
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                currentChoosenAlphabetIndex = pressI;
                //回调监听器
