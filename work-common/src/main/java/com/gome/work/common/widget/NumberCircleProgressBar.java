...
/**
 * Created by liubomin on 2017/2/20.
 */
public class NumberCircleProgressBar extends View {
    ...
    private final int DEFAULT_REACHED_COLOR = Color.argb(200,66, 145, 241);
    private final int DEFAULT_UNREACHED_COLOR = Color.argb(107,0, 0, 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDrawReachedBar) {
            switch (mFillMode) {
                ...
                case 2:
                    if(getProgress()>0){
                        canvas.drawArc(mCircleRectF, DEFAULT_INITIAL_ANGLE,-(360-
                                getProgress() * 360 / getMax()), true, mCirclePaint);
                    }
                    break;
                case 1:
