...
import com.gome.work.common.widget.pickerview.data.Type;
import com.gome.work.common.widget.pickerview.data.WheelCalendar;
import com.gome.work.common.widget.pickerview.listener.OnDateSetListener;
 ...
 */
public class TimePickerDialog extends DialogFragment implements View.OnClickListener, OnDateSetListener {
    PickerConfig mPickerConfig;
    private TimeWheel mTimeWheel;
    private long mCurrentMillSeconds;
    SimpleDateFormat sf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    private OnTimePickerClick onTimePickerClick;
    ...
    View initView() {
        ...
        View view = DataBindingUtil.inflate(inflater, R.layout.timepicker_layout, null, false).getRoot();
        ...
        toolbar.setBackgroundColor(mPickerConfig.mToolBarTVColor);
    ...
    */
    ...
    public void onDateSet(TimePickerDialog timePickerView, long millseconds) {
        ...
        if (null != onTimePickerClick)
            onTimePickerClick.onClick(text);
    }
    ...
    public void setOnTimePickerClick(OnTimePickerClick onTimePickerClick) {
        this.onTimePickerClick = onTimePickerClick;
    }
