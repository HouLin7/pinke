...
class UserAdapter(fragmentActivity: FragmentActivity) : BaseRecyclerAdapter<UserInfo>(fragmentActivity) {

    override fun onCreateMyViewHolder(parent: ViewGroup?, viewType: Int): BaseViewHolder<UserInfo>? {
        var view: View = LayoutInflater.from(mActivity).inflate(R.layout.adapter_user_list_item, null);
